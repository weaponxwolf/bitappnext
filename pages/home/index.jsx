    ...
    <div className='mt-3'>
      {posts.map((post)=>(
        <Card className='px-3 py-3 my-1' key={post._id} style={{ boxShadow: "rgba(17, 12, 46, 0.15) 0px 48px 100px 0px",borderRadius:"1rem"}}>
          ...
          <Card style={{position:"relative",maxWidth:"100%",height:"50vh",borderWidth:"0px"}}><Image priority="false" alt={post.images[0]} src={"http://localhost:3010/posts/images/"+post.images[0]} layout='fill' objectFit='contain'/></Card>
...
function LeftSideMenu() {
  return (
    <div className='card mt-3' style={{ boxShadow: "rgba(17, 12, 46, 0.15) 0px 48px 100px 0px"}}>
      <ListGroup >
        <Link href="/posts/newpost"><a><ListGroup.Item style={{display:"flex",alignItems:"center"}}> <div style={{position:"relative",height:"1rem",width:"1rem"}}><Image src="/assets/img/plus.png" alt="plus" layout='fill'/></div>New Post</ListGroup.Item></a></Link>
      </ListGroup>
    </div>
  )
}
